        ...
        <div class="module item">
            ...
            <main class="module__content--three module__content fn__clear ft__center" >
                <div style="text-align: center;width: 100%;height: 100px" >
                    <iframe  frameborder="no" border="0" marginwidth="0" marginheight="0"  width=250 height=86 src="//music.163.com/outchain/player?type=2&id=${customVars.music}&auto=1&height=66"></iframe>
                </div>
            </main>
        </div>
    </#if>
